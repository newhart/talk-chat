...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.cdnfonts.com/css/arista-pro-alternate" rel="stylesheet">
    ...
    <body class="font-sans antialiased" style="font-family: Arista Pro Alternate; font-weight: bold;">
        @inertia
    </body>
</html>
